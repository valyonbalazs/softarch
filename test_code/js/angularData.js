...
projectApp.controller('ProjectController', ['$scope', 'taskDataSharerService', function ($scope, taskDataSharerService) {
    $scope.project = [
        {
          projectId: 1,
...
/*controllers.ModalTaskController = function ($scope) {
...
projectApp.controller('RiskController', ['$scope', 'taskDataSharerService', function ($scope, taskDataSharerService) {
    $scope.risks = [
      {
        riskId: 1,
